...
namespace CustomerMaintenance
{
    public partial class Form1 : Form
    {
        ...
        {
            // *** Use both syntax to get a list of state objects sorted by statename - LINQ is the first, SQL the second
            ...
            // *** create an "implicitly typed" list that contains just the customer id and name. example of old syntax!
        ...
        {
            // *** Use both syntax to return implicitly typed list. first old, then new
            //var customers = (from c in MMABooksEntity.mmaBooks.Customers orderby c.Name select new { c.CustomerID, c.Name }).ToList();
            ...
            //var invoices = MMABooksEntity.mmaBooks.Invoices.Join(
            //   MMABooksEntity.mmaBooks.Customers,
